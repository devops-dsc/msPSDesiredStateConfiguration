...
configuration Sample_msDSCWebService
{
    param 
    (
    ...
    Node $NodeName
    {
        ...
        msDSCWebService PSDSCPullServer
        {
            Ensure                  = "Present"
        ...
        msDSCWebService PSDSCComplianceServer
        {
            Ensure                  = "Present"
            ...
            DependsOn               = @("[WindowsFeature]DSCServiceFeature","[msDSCWebService]PSDSCPullServer")
        }
    }
 }
