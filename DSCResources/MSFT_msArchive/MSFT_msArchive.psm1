...
$compressCacheLocation = "$env:ProgramData\Microsoft\PSDesiredStateConfiguration\DSCResources\msArchive\Cache"
...
function Set-TargetResource 
{
   ...
   if($DestinationType -eq "File")
   {
        ...
        Compress-msArchive -Path $Path -DestinationPath $Destination -CompressionLevel $CompressionLevel
...
<#
.SYNOPSIS 
The Compress-msArchive cmdlet can be used to zip/compress one or more files/directories.
#>
function Compress-msArchive
{
    [CmdletBinding(
